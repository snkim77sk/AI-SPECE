"""Top-level Cafe24 AI SPACE entrypoint for SINSUNG G2B DATA VIEW 2.3."""
import os
import secrets
import sys
import time
...
# Real-data-only policy. 2.3 keeps the verified two-hour scheduler enabled.
...
# Keep exactly the proven 2.2 startup/import layout. 2.3 history is implemented
# only inside already-deployed v220/scheduler files; no new startup modules.
...
# Same existing module name as 2.2; now also exposes 2025 history controls.
...
# Same existing Cafe24-safe wrapper module as 2.2.
