"""Top-level Cafe24 AI SPACE entrypoint for SINSUNG G2B DATA VIEW 2.2.1."""
import os
import secrets
import sys
import time
...
# Real-data-only policy. 2.2.1 keeps the verified two-hour scheduler enabled.
...
# Keep the proven 2.2 startup/import layout unchanged.
...
# Existing v220 UI module only; 2.2.1 adds shopping-history file upload there.
...
# Existing Cafe24-safe v220 wrapper only; no new startup modules.
